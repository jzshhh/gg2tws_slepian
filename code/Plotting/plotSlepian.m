...
%
% Description: Plotting Spatial basic functions
%
% Input:
%   val          Eigenvalues in order
%   vec          Unitary matrix of localization coefficients
%   lmax         Maximal degree
%   l            Number of selected Spatial basic functions
...
ha=tight_subplot(numraw,nplot,[.03 .01],[.03 .03],[.01 .03]);
for z=1:length(l)
...
close(wbh);
export_fig('result/figure/Slepian.pdf');
delete(gcf);
