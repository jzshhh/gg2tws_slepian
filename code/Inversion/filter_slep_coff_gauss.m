...
%
% Description: Filtering slepian coefficient
%
% Input:
...
%
% Input:
%   Ulm         Integral_boundary file
%   time        Name of study region
%   timespan
% Output:
%   CS          Eigenvalues in order
...
%
% Description: Converting slepian coefficients to 
%
% Input:
%   vec             Integral_boundary file
% Output:                
%   clm             Eigenvalues in order
%   slm             Unitary matrix of localization coefficients
%   dl              Eigenvalues in order
%   dm              Unitary matrix of localization coefficients
...
%
% Description: Calculating eigenvalues and eigenvectors of D matrix
%
% Input:
