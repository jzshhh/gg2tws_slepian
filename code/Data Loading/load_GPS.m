function [sites,position,times_mon,data_mon]=load_GPS(udir,form,site_info_file,timespan)
% 
...
sitetmp=char(sites_info{1});positmp=[sites_info{2}+360 sites_info{3}];
fclose(fid);
...
for i=1:n           
    ...
    data(:,i)=smoothdata(smoothdata(data(:,i),'movmedian',15,'omitnan'),'movmean',15,'omitnan'); % Applying a 10-day moving average filtering
    [times_mon,data_mon(:,i)]=month_aver(data(:,i),times);
